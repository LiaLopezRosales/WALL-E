...
public class Node
{
    ...
    public enum NodeType{Instructions,GlobalVar,GlobalSeq,VarName,Assigment,Low_Hyphen,Let_exp,Draw,Conditional,IF,Else,FucName,Declared_FucName,Declared_Fuc,ParName,Negation,Var,parameters,Fuction,Concat,And,Or,Minor,Major,Equal_Minor,Equal_Major,Equal,Diferent,Sum,Sub,Mul,Div,Module,Pow,No,Number,Circle,Point,Line,Ray,Segment,Arc,Point_Seq,Line_Seq,Color,Restore,Import,Point_Fuc,Line_Fuc,Segment_Fuc,Ray_Fuc,Circle_Fuc,Measure,Measure_Fuc,Intersect,Count,Text,Cos,Sin,Log,Sqrt,Tan,Atan,Abs,Floor,Ceil,Phi,Sqrt2,Seed,Print,ColorRgb,ColorRgba,Points,Randoms,Samples,Empty_Seq,Enclosed_Infinite_Seq,Infinite_Seq,Finite_Seq,PI,E,Indefined,Undefined};
